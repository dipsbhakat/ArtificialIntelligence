...
class AdvancedHeadshotProcessor:
    ...
    def skin_smoothing(self, image: np.ndarray, 
        ...
        # Blend with original
        result = cv2.addWeighted(img_float, 1 - intensity, 
    ...
    def enhance_eyes(self, image: np.ndarray) -> np.ndarray:
        ...
        # Merge channels
        enhanced = cv2.merge([luminance, a, b])
        
        # Convert back to BGR
        return cv2.cvtColor(enhanced, cv2.COLOR_LAB2BGR)
    
    def add_subtle_vignette(self, image: Image.Image, 
